...
**eDischarge** (inpatient discharge summary) Document – A ITK3 FHIR Document containing Transfer of Care information supporting an inpatient discharge typically between an acute hospital and GP practice.
...
The [ITK3 eDischarge journey](overview_message_journey.html) outlines the development roadmap for FHIR Messaging using the ITK3 eDischarge outlined messaging within this site. Note: This roadmap would include components from other NHS Digital specifications for example ITK3 eDischarge message components, CareConnect profiles etc.
