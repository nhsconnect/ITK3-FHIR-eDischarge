...
The diagram shows the referencing between organization, practitioner and practitionerRole which applies to all the message in the ITK3 eDischarge specification.
